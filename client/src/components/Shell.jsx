    ...
    <div style={{ minHeight: '100vh', maxWidth: 430, margin: '0 auto', position: 'relative', zIndex: 1, background: '#f5f5f7' }}>
            ...
            <div style={{
              ...
              {[
                ...
                <button key={i} onClick={item.action} style={{
                  ...
                  background: 'none', border: 'none', borderTop: i > 0 ? '1px solid #e5e5e7' : 'none',
                  textAlign: 'left',
                }}>
      ...
      {!isOverlay && (
        <div style={{
          ...
          <div style={{ display: 'flex', flex: 1, background: '#f0f0f2', borderRadius: 16, padding: '4px' }}>
            {[
