  ...
  if (!token) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, background: '#f5f5f7' }}>
      <div style={{ textAlign: 'center' }}>
        <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 8, color: '#1a1a1a' }}>Invalid reset link</div>
        <Link to="/forgot-password" style={{ fontSize: 14, color: '#3b82f6', textDecoration: 'none' }}>Request a new one</Link>
      </div>
    </div>
  );
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, background: '#f5f5f7' }}>
      <div style={{ width: '100%', maxWidth: 380, background: '#ffffff', border: '1px solid #e5e5e7', borderRadius: 16, padding: 32 }}>
        ...
        {success ? (
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 8, color: '#1a1a1a' }}>Password updated</div>
            <Link to="/login" style={{ fontSize: 14, color: '#3b82f6', textDecoration: 'none' }}>Log in</Link>
          </div>
        ) : (
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: 14 }}>
              <label style={{ fontSize: 11, fontWeight: 700, color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.5px' }}>New Password</label>
            ...
            <div style={{ marginBottom: 20 }}>
              <label style={{ fontSize: 11, fontWeight: 700, color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Confirm Password</label>
