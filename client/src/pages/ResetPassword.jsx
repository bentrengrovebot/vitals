...
export default function ResetPassword() {
  ...
  const inp = { width: '100%', padding: '14px 16px', borderRadius: 12, border: '1.5px solid #eaeaef', background: '#fff', fontSize: 15, marginTop: 4 };

  if (!token) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, background: '#f8f8fa' }}>
      <div style={{ textAlign: 'center' }}>
        <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 8 }}>Invalid reset link</div>
        <Link to="/forgot-password" style={{ fontSize: 14 }}>Request a new one</Link>
      </div>
    </div>
  );
      ...
      <div style={{ width: '100%', maxWidth: 380 }}>
        ...
        {success ? (
          <div style={{ textAlign: 'center' }}>
            ...
            <Link to="/login" style={{ fontSize: 14 }}>Log in</Link>
          </div>
        ) : (
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: 14 }}>
              <label style={{ fontSize: 11, fontWeight: 700, color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.5px' }}>New Password</label>
            ...
            <div style={{ marginBottom: 20 }}>
              <label style={{ fontSize: 11, fontWeight: 700, color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Confirm Password</label>
