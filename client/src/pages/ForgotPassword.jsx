      ...
      <div style={{ width: '100%', maxWidth: 380, background: '#ffffff', border: '1px solid #e5e5e7', borderRadius: 16, padding: 32 }}>
        ...
        {sent ? (
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 8, color: '#1a1a1a' }}>Check your email</div>
            <div style={{ fontSize: 14, color: '#6b7280', marginBottom: 20 }}>If an account exists for {email}, we've sent a reset link.</div>
            <Link to="/login" style={{ fontSize: 14, color: '#3b82f6', textDecoration: 'none' }}>Back to login</Link>
          </div>
        ) : (
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: 20 }}>
              ...
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} required
                style={{ width: '100%', padding: '14px 16px', borderRadius: 12, border: '1px solid #e5e5e7', background: '#ffffff', fontSize: 15, marginTop: 4, color: '#1a1a1a' }} />
            </div>
